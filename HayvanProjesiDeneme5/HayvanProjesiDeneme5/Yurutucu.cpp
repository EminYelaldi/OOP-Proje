...
int main() {
    ...
    /*
     * Testteki tÃ¼m caselerin Ã§alÄ±ÅŸmasÄ± durumunda 60 puan alacaksÄ±nÄ±z.
     * Hayvan ekleme 20 puan
     * HayvanlarÄ±n gÃ¶sterilmesi 10 puan
     * HayvanlarÄ±n beslenmesi 10 puan
     * HayvanlarÄ±n dÃ¼zenlenmesi 20 puan
     * */

    Hayvan* aslan1 = new Aslan("Simba", "Aslan", 5, "Kahverengi");
    Hayvan* aslan2 = new Aslan("Mufasa", "Aslan", 8, "SarÄ±");
    ...
    if (hayvanatBahcesi.hayvanlar.size() == 9) {
        for (Hayvan* hayvan : hayvanatBahcesi.hayvanlar) {
            if (hayvan->getAd() == "Simba") {
                std::cout << "HAYVAN EKLE BAÅARILI: 20 PUAN" << std::endl;
                break;
            }
        }
    }
    ...
    std::cout << "----- HayvanlarÄ± Besleme -----" << std::endl;
    ...
    for (Hayvan* hayvan : hayvanatBahcesi.hayvanlar) {
        if (hayvan->getAd() == "Simba" && hayvan->getYas() == 6) {
            std::cout << "HAYVAN DÃœZENLE BAÅARILI: 20 puan" << std::endl;
            break;
        }
    }
